        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "gmail_query": {
                        "type": "string",
                        "description": "Gmail search query (X-GM-RAW), e.g. from:github is:unread newer_than:14d",
                    },
                    "mailbox": {
                        "type": "string",
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "max_body_chars": {
                        "type": "integer",
                        "description": "Max characters of body text (default 24000, max 100000)",
                    },
                },
                "required": ["uid"],
            },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "gmail_query": {
                        "type": "string",
                        "description": "Same as gmail_search (Gmail query syntax)",
                    },
                    "mailbox": {"type": "string", "description": "Default INBOX"},
                    "max_messages": {
                        "type": "integer",
                        "description": "How many messages to include (1–15, default 8)",
                    },
                    "max_chars_per_message": {
                        "type": "integer",
                        "description": "Truncate each body (default 6000)",
                    },
                },
                "required": ["gmail_query"],
            },
